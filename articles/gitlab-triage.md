...
[この記事は 富士通クラウドテクノロジーズ Advent Calendar 2021](https://qiita.com/advent-calendar/2021/fjct) の2日目の記事です。
...
ちなみに、今回は詳しく説明しませんが、GitLab Triageとは違う視点で、コードレビューに関する処理を自動化をする [Danger bot](https://docs.gitlab.com/ee/development/dangerbot.html) というものもあります。プロジェクト運用によっては、Dangerが適切な選択肢になることもあるでしょう。
